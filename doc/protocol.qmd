...
Cox proportional hazards regression substitution analyses will be conducted in a study sample restricted to consumers of legumes (i.e. removing non legume consumers). 
...
be estimated following adjustment levels in model 2. In these analyses, no single food components will be excluded from β3’ and there will not be adjusted for the total intake of all foods (β2). This analysis will also be conducted among consumers only.
...
All secondary and sensitivity analyses followed the adjustment level in model 2 from the main analysis (i.e. all covariates were included except BMI).
